...
- **Continuous Evolution (The Critic Rule):** At the start of every session, the agent MUST read `.agent/CRITIC.md` and `memory.db` to incorporate all previous user feedback and context.
...
- **Branding Excellence (v3.0):** All Docs, Slides, and Sheets must adhere to the standards defined in `.agent/BRANDING.md` (Colors: #0a2373, #00cfe1).
