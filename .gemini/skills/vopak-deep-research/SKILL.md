...
# 🔬 Vopak Deep Research Skill (v1.1)

This skill transforms GeminiClaw into a proactive research powerhouse, capable of conducting multi-layered investigations into technical, market, or regulatory topics. Version 1.1 adds **Code Intelligence** by directly scanning GitHub repositories for implementation truth.
...
- **Flat-Rate Execution:** Utilize native CLI tools (`google_web_search`, `web_fetch`, `github-mcp`) to stay within the existing license.
...
## 📈 Proactive Bridge
Once research is complete, the skill MUST:
