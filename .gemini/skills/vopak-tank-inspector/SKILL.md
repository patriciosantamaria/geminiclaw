...
description: Automates the end-to-end inspection reporting for Vopak global terminals. Use for analyzing drone frames via Vertex AI, correlating visual and sensor data, and generating terminal-ready branded reports.
---
